...
from sqlalchemy import create_engine, text  # DB와의 연결, sql 쿼리문 날리는 것에만 sqlalchemy 사용
...
class CustomJSONEncoder(JSONEncoder):  # JSONEncoder 상속
...
def create_app(test_config=None):
    ...
    app.json_encoder = CustomJSONEncoder  # set 자료형을 json으로 변환하기 위해
